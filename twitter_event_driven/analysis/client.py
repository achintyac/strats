...
class FtxClient:
    ...
    #                 reduce_only: bool, ioc: bool, post_only: bool,
    ...
    #
    # def cancel_orders(self, market_name: str, conditional_orders: bool = False,
    ...
    #     return results
    #
    # def get_spot_margin_info(self, market: str = None) -> dict:
